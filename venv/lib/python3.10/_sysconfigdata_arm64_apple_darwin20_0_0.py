...
build_time_vars = {'ABIFLAGS': '',
 ...
 'BASEMODLIBS': '',
 'BINDIR': '/Volumes/Praneeth.work/NVIDIA VENV ENVIRONM/venv/bin',
 'BINLIBDEST': '/Volumes/Praneeth.work/NVIDIA VENV ENVIRONM/venv/lib/python3.10',
 ...
 'BLDSHARED': 'arm64-apple-darwin20.0.0-clang -bundle -undefined '
              ...
              '-Wl,-rpath,/Volumes/Praneeth.work/NVIDIA VENV ENVIRONM/venv/lib '
              '-L/Volumes/Praneeth.work/NVIDIA VENV ENVIRONM/venv/lib '
              ''
              ''
              '-Wl,-pie -Wl,-headerpad_max_install_names '
              '-Wl,-dead_strip_dylibs '
 ...
 'CFLAGS': '-Wno-unused-result -Wsign-compare -Wunreachable-code -DNDEBUG -g '
           ...
           '-isystem '
           '/Volumes/Praneeth.work/NVIDIA VENV ENVIRONM/venv/include '
           ' '
           ' '
           '-arch arm64  '
           ''
 ...
 'CONFIGURE_CPPFLAGS': ''
                       ...
                       '-I/Volumes/Praneeth.work/NVIDIA VENV ENVIRONM/venv/include',
 'CONFIGURE_LDFLAGS': ''
                      ''
                      '-Wl,-pie -Wl,-headerpad_max_install_names '
                      '-Wl,-dead_strip_dylibs '
 ...
 'CONFIG_ARGS': "'--prefix=/Volumes/Praneeth.work/NVIDIA VENV ENVIRONM/venv' "
                "'--build=arm64-apple-darwin20.0.0' "
                "'--host=arm64-apple-darwin20.0.0' '--enable-ipv6' "
                "'--with-ensurepip=no' "
                "'--with-tzpath=/Volumes/Praneeth.work/NVIDIA VENV ENVIRONM/venv/share/zoneinfo:/Volumes/Praneeth.work/NVIDIA VENV ENVIRONM/venv/share/tzinfo' "
                "'--with-computed-gotos' '--with-system-ffi' "
                "'--enable-loadable-sqlite-extensions' "
                "'--with-tcltk-includes=-I/Volumes/Praneeth.work/NVIDIA VENV ENVIRONM/venv/include' "
                "'--with-tcltk-libs=-L/Volumes/Praneeth.work/NVIDIA VENV ENVIRONM/venv/lib "
                ...
                '-mmacosx-version-min=11.1 '
                "-I/Volumes/Praneeth.work/NVIDIA VENV ENVIRONM/venv/include'",
 'CONFINCLUDEDIR': '/Volumes/Praneeth.work/NVIDIA VENV ENVIRONM/venv/include',
 'CONFINCLUDEPY': '/Volumes/Praneeth.work/NVIDIA VENV ENVIRONM/venv/include/python3.10',
 'COREPYTHONPATH': '',
 ...
 'DESTDIRS': '/Volumes/Praneeth.work/NVIDIA VENV ENVIRONM/venv '
             '/Volumes/Praneeth.work/NVIDIA VENV ENVIRONM/venv/lib '
             '/Volumes/Praneeth.work/NVIDIA VENV ENVIRONM/venv/lib/python3.10 '
             '/Volumes/Praneeth.work/NVIDIA VENV ENVIRONM/venv/lib/python3.10/lib-dynload',
 'DESTLIB': '/Volumes/Praneeth.work/NVIDIA VENV ENVIRONM/venv/lib/python3.10',
 'DESTPATH': '',
 'DESTSHARED': '/Volumes/Praneeth.work/NVIDIA VENV ENVIRONM/venv/lib/python3.10/lib-dynload',
 'DFLAGS': '',
 'DIRMODE': 755,
 ...
 'INCLDIRSTOMAKE': '/Volumes/Praneeth.work/NVIDIA VENV ENVIRONM/venv/include '
                   '/Volumes/Praneeth.work/NVIDIA VENV ENVIRONM/venv/include '
                   '/Volumes/Praneeth.work/NVIDIA VENV ENVIRONM/venv/include/python3.10 '
                   '/Volumes/Praneeth.work/NVIDIA VENV ENVIRONM/venv/include/python3.10',
 'INCLUDEDIR': '/Volumes/Praneeth.work/NVIDIA VENV ENVIRONM/venv/include',
 'INCLUDEPY': '/Volumes/Praneeth.work/NVIDIA VENV ENVIRONM/venv/include/python3.10',
 ...
 'LDVERSION': '3.10',
 'LIBC': '',
 'LIBDEST': '/Volumes/Praneeth.work/NVIDIA VENV ENVIRONM/venv/lib/python3.10',
 'LIBDIR': '/Volumes/Praneeth.work/NVIDIA VENV ENVIRONM/venv/lib',
 'LIBFFI_INCLUDEDIR': '',
 'LIBM': '',
 'LIBOBJDIR': 'Python/',
 'LIBOBJS': '',
 'LIBPC': '/Volumes/Praneeth.work/NVIDIA VENV ENVIRONM/venv/lib/pkgconfig',
 'LIBPL': '/Volumes/Praneeth.work/NVIDIA VENV ENVIRONM/venv/lib/python3.10/config-3.10-darwin',
 'LIBPYTHON': '',
 ...
 'MACHDEP': 'darwin',
 'MACHDEP_OBJS': '',
 'MACHDESTLIB': '/Volumes/Praneeth.work/NVIDIA VENV ENVIRONM/venv/lib/python3.10',
 ...
 'MANDIR': '/Volumes/Praneeth.work/NVIDIA VENV ENVIRONM/venv/share/man',
 ...
 'NO_AS_NEEDED': '',
 'OBJECT_OBJS': '\\',
 'OPENSSL_INCLUDES': '-I/Volumes/Praneeth.work/NVIDIA VENV ENVIRONM/venv/include',
 'OPENSSL_LDFLAGS': '-L/Volumes/Praneeth.work/NVIDIA VENV ENVIRONM/venv/lib',
 ...
 'RETSIGTYPE': 'void',
 'RUNSHARED': '',
 'SCRIPTDIR': '/Volumes/Praneeth.work/NVIDIA VENV ENVIRONM/venv/lib',
 'SETPGRP_HAVE_ARG': 0,
 'SGI_ABI': '',
 'SHELL': '/bin/sh',
 ...
 'TCLTK_INCLUDES': '-I/Volumes/Praneeth.work/NVIDIA VENV ENVIRONM/venv/include',
 'TCLTK_LIBS': '-L/Volumes/Praneeth.work/NVIDIA VENV ENVIRONM/venv/lib '
               '-ltcl8.6 -ltk8.6',
 'TESTOPTS': '',
 'TESTPATH': '',
 ...
 'TM_IN_SYS_TIME': 0,
 'TZPATH': '/Volumes/Praneeth.work/NVIDIA VENV ENVIRONM/venv/share/zoneinfo:/Volumes/Praneeth.work/NVIDIA VENV ENVIRONM/venv/share/tzinfo',
 'UNICODE_DEPS': '\\',
 'UNIVERSALSDK': '',
 ...
 'datarootdir': '/Volumes/Praneeth.work/NVIDIA VENV ENVIRONM/venv/share',
 'exec_prefix': '/Volumes/Praneeth.work/NVIDIA VENV ENVIRONM/venv',
 'prefix': '/Volumes/Praneeth.work/NVIDIA VENV ENVIRONM/venv',
